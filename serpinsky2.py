...
draw_pixel = lambda coords: canvas.create_rectangle(coords[0], coords[1], coords[0] + 1, coords[1] + 1, fill="white",
                                                    outline="white")
window = tkinter.Tk()
canvas = tkinter.Canvas(window, width=600, height=600, bg="black")
canvas.pack()
tringle = [[random.randint(0, 600), random.randint(0, 600)], [random.randint(0, 600), random.randint(0, 600)],
